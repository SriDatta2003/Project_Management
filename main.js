document.addEventListener("DOMContentLoaded", function () {
    ...
    const allowedNames = ["Ram", "Charan", "Arjun", "Vijay", "Surya"];
    ...
    form.addEventListener("submit", function (event) {
        ...
        newTask.innerHTML = `
            <div class="task-info" style="background-color:white ;border-radius:5px ;">  
            <h4 >${taskName}</h4><br><br>
            ...
            <div class="comment-section">
                ...
                <select class="commenter-names">
                    ...
                    <option value="Arujun">Arjun</option>
